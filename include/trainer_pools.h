...
enum PoolPruneOptions {
    ...
    POOL_PRUNE_NON_NORMAL,
    POOL_PRUNE_NON_FIGHTING,
    POOL_PRUNE_NON_FLYING,
    POOL_PRUNE_NON_POISON,
    POOL_PRUNE_NON_GROUND,
    POOL_PRUNE_NON_ROCK,
    POOL_PRUNE_NON_BUG,
    POOL_PRUNE_NON_GHOST,
    POOL_PRUNE_NON_STEEL,
    POOL_PRUNE_NON_FIRE,
    POOL_PRUNE_NON_WATER,
    POOL_PRUNE_NON_GRASS,
    POOL_PRUNE_NON_ELECTRIC,
    POOL_PRUNE_NON_PSYCHIC,
    POOL_PRUNE_NON_ICE,
    POOL_PRUNE_NON_DRAGON,
    POOL_PRUNE_NON_DARK,
    POOL_PRUNE_NON_FAIRY,
    POOL_PRUNE_NON_GROUND_ROCK,
    POOL_PRUNE_NON_ROCK_STEEL,
