...
enum __attribute__((packed)) Item
{
    ...
    ITEM_TM_FOCUS_PUNCH = ITEM_HM01,
    ITEM_TM_WATER_PULSE = ITEM_HM01,
    ITEM_TM_ROAR = ITEM_HM01,
    ITEM_TM_HAIL = ITEM_HM01,
    ITEM_TM_HYPER_BEAM = ITEM_HM01,
    ITEM_TM_SAFEGUARD = ITEM_HM01,
    ITEM_TM_FRUSTRATION = ITEM_HM01,
    ITEM_TM_DOUBLE_TEAM = ITEM_HM01,
    ITEM_TM_SHOCK_WAVE = ITEM_HM01,
    ITEM_TM_AERIAL_ACE = ITEM_HM01,
    ITEM_TM_SECRET_POWER = ITEM_HM01,
    ITEM_TM_TORMENT = ITEM_HM01,
    ITEM_TM_ATTRACT = ITEM_HM01,
    ITEM_TM_STEEL_WING = ITEM_HM01,
    ITEM_TM_SNATCH = ITEM_HM01,
    ITEM_TM_SKILL_SWAP = ITEM_HM01,
    ITEM_HM_FLY = ITEM_HM01,
    ...
    ITEM_CARD_KEY = 750,
    ITEM_LIFT_KEY = 751,
    ITEM_INFINITE_REPEL = 752,
    ITEM_SILPH_SCOPE = ITEM_INFINITE_REPEL,
    ITEM_NOTEBOOK = 753,
    ITEM_TRI_PASS = ITEM_NOTEBOOK,
    ITEM_INFINITE_CANDY = 754,
    ITEM_RAINBOW_PASS = ITEM_INFINITE_CANDY,
    ITEM_HEXORB = 755,
    ITEM_TEA = ITEM_HEXORB,
    ITEM_RUBY = 756,
    ITEM_SAPPHIRE = 757,
    ITEM_SLEDGEHAMMER = ITEM_PARCEL,
    ITEM_MACHETE = ITEM_PARCEL,
    ITEM_DIVING_SUIT = ITEM_PARCEL,
    ITEM_FLASHLIGHT = ITEM_PARCEL,
    ITEM_POWER_GLOVE  = ITEM_PARCEL,
    ITEM_SURFBOARD = ITEM_PARCEL,
    ITEM_TM_DIVE = ITEM_PARCEL,
    ...
    ITEM_ABILITY_SNACK = 825,
    ITEM_SWAP_SNACK = ITEM_ABILITY_SNACK,
