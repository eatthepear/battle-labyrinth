...
enum __attribute__((packed)) Item
{
    ...
    ITEM_SURFBOARD = 746,
    ITEM_PARCEL = ITEM_SURFBOARD,
    ITEM_OAKS_PARCEL = ITEM_PARCEL, // Pre-Gen IV name
    ITEM_MACHETE = 747,
    ITEM_SECRET_KEY = ITEM_MACHETE,
    ITEM_SLEDGEHAMMER = 748,
    ITEM_BIKE_VOUCHER = ITEM_SLEDGEHAMMER,
    ITEM_DIVING_SUIT = 749,
    ITEM_GOLD_TEETH = ITEM_DIVING_SUIT,
    ITEM_FLASHLIGHT = 750,
    ITEM_CARD_KEY = ITEM_FLASHLIGHT,
    ITEM_POWER_GLOVE = 751,
    ITEM_LIFT_KEY = ITEM_POWER_GLOVE,
