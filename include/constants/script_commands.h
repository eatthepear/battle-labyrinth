...
enum ScrOp
{
    ...
    SCR_OP_QUESTMENU = 0xE7,
    SCR_OP_SUBQUESTMENU = 0xE8,
    SCR_OP_RETURNQUESTSTATE = 0xE9,
    SCR_OP_SETWILDBATTLE_PBL = 0xEA,
    SCR_OP_CHECKSPECIESCLAUSE = 0xEB,
    SCR_OP_GETITEMQUANTITY = 0xEC,
    SCR_OP_POKEVIAL = 0xED,
};
