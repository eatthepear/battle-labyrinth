...
#define NUM_FISHING_MONS_GOOD_ROD_ENCOUNTER_SLOTS (5)

#define NUM_FISHING_MONS_OLD_ROD_ENCOUNTER_SLOTS (1)

#define NUM_FISHING_MONS_SUPER_ROD_ENCOUNTER_SLOTS (1)
#define NUM_FISHING_MONS_ENCOUNTER_SLOTS (7)

#define NUM_HIDDEN_MONS_ENCOUNTER_SLOTS (5)
