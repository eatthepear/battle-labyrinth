...
enum BeatBossFlags {
    ...
    FLAG_BEAT_BOSS_33,
    FLAG_BEAT_BOSS_34,
    FLAG_BEAT_BOSS_35_LACEY,
    FLAG_BEAT_BOSS_35_GLACIA,
    FLAG_BEAT_BOSS_35_KOGA,
    FLAG_BEAT_BOSS_35_SHAUNTAL,
    FLAG_BEAT_BOSS_35_CYNTHIA,
};
...
enum CustomScriptsFlags {
    ...
    FLAG_HIDE_SANCTUARY_PROTON,
    FLAG_HIDE_SANCTUARY_PROTON_GRUNTS,
    FLAG_HIDE_SANCTUARY_MAGNEMITES,
    FLAG_HIDE_SANCTUARY_COLRESS,
