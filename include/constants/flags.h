...
enum CustomItemFlags {
    FLAG_ZONE_SANCTUARY_RECEIVED_HONEY = 0x400,
    FLAG_ITEM_ZONE1A_RANDOM_1,
    ...
    FLAG_ITEM_ZONE11A_TM_SHADOW_CLAW,
    ...
    FLAG_ITEM_ZONE15A_RANDOM_1,
    FLAG_ITEM_ZONE15A_SHELL_BELL,
    FLAG_ITEM_ZONE15A_ICE_STONE,
    FLAG_ITEM_ZONE15A_RANDOM_2,
    FLAG_ITEM_ZONE15A_TM_AURORA_VEIL,
    FLAG_ITEM_ZONE16A_TM_FLY,
    FLAG_ITEM_ZONE16A_RANDOM_1,
    FLAG_ITEM_ZONE16A_RANDOM_2,
    FLAG_ITEM_ZONE16A_RANDOM_3,
    FLAG_ITEM_ZONE17A_TM_HEX,
    FLAG_ITEM_ZONE18A_LINKING_CORD,
    FLAG_ITEM_ZONE18A_TM_U_TURN,
