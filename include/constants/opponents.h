...
enum {
    ...
    TRAINER_PBL_MIRAGE_BOSS_13,
    TRAINER_PBL_MIRAGE_BOSS_13_CHALLENGE,
    TRAINER_PBL_LILY_BOSS_14,
    TRAINER_PBL_LILY_BOSS_14_CHALLENGE,
    TRAINER_PBL_AXLE,
    TRAINER_PBL_RAFAEL,
    TRAINER_PBL_GEORGINA,
    TRAINER_PBL_MIA_BOSS_15,
    TRAINER_PBL_MIA_BOSS_15_CHALLENGE,
    TRAINER_PBL_DORIS,
    TRAINER_PBL_HOMER,
    TRAINER_PBL_JOHN,
    TRAINER_PBL_GLENN,
    ...
    TRAINER_PBL_ELTON,
    TRAINER_PBL_WILLIE,
    TRAINER_PBL_ZOE_AND_ELI_BOSS_16,
    TRAINER_PBL_ZOE_AND_ELI_BOSS_16_CHALLENGE,
