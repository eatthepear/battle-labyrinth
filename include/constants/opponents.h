...
enum {
    ...
    TRAINER_PBL_MARIAM,
    TRAINER_PBL_OSCAR,
    TRAINER_PBL_CORI_LEVIATHAN_1_GRASS_STARTER,
    TRAINER_PBL_CORI_LEVIATHAN_1_FIRE_STARTER,
    TRAINER_PBL_CORI_LEVIATHAN_1_WATER_STARTER,
    TRAINER_PBL_POLLY,
    ...
    TRAINER_PBL_PROTON_LEVIATHAN_4,
    TRAINER_PBL_REBECCA,
    TRAINER_PBL_CAITLYN,
    TRAINER_PBL_SYLVIA,
    TRAINER_PBL_THERESA,
    ...
    TRAINER_PBL_ARCHER_LEVIATHAN_11,
    TRAINER_PBL_HILDA,
    TRAINER_PBL_DOLORES,
    TRAINER_PBL_TREVOR,
    TRAINER_PBL_KINLEY,
    ...
    TRAINER_PBL_JULIE,
    TRAINER_PBL_RUFUS,
    TRAINER_PBL_SERENA_LEVIATHAN_12,
    TRAINER_PBL_VIOLET,
    TRAINER_PBL_WANDA,
    ...
    TRAINER_PBL_NEWTON_LEVIATHAN_13,
    ...
    TRAINER_PBL_COURTNEY_LEVIATHAN_14,
    TRAINER_PBL_LEAF_LEVIATHAN_17,
    TRAINER_PBL_LARRY_LEVIATHAN_18,
    ...
    TRAINER_PBL_JUPITER_LEVIATHAN_16,
