...
enum {
    ...
    TRAINER_PBL_MARIAM,
    TRAINER_PBL_OSCAR,
    TRAINER_PBL_CORI_BOSS_1_GRASS_STARTER,
    TRAINER_PBL_CORI_BOSS_1_FIRE_STARTER,
    TRAINER_PBL_CORI_BOSS_1_WATER_STARTER,
    TRAINER_PBL_POLLY,
    TRAINER_PBL_JEREMIAH,
    TRAINER_PBL_JOSH,
    TRAINER_PBL_HARPER,
    TRAINER_PBL_LEAF_BOSS_2,
    TRAINER_PBL_SHAUN_OPTIONAL_2,
    TRAINER_PBL_JEMMA,
    TRAINER_PBL_RICHARD,
    TRAINER_PBL_PATRICK,
    TRAINER_PBL_LUNA_AND_NORA,
    TRAINER_PBL_BORIS,
    TRAINER_PBL_BILL_OPTIONAL_3,
    TRAINER_PBL_GRANT_BOSS_3,
    TRAINER_PBL_RALPH,
    TRAINER_PBL_SANTIAGO,
    TRAINER_PBL_CHLOE_AND_KAYA,
    TRAINER_PBL_ROCKET_GRUNT_4D_1,
    TRAINER_PBL_ROCKET_GRUNT_4D_2,
    TRAINER_PBL_ROCKET_GRUNT_4E_1,
    TRAINER_PBL_ROCKET_GRUNT_4E_2,
    TRAINER_PBL_PROTON_BOSS_4,
    TRAINER_PBL_REBECCA,
    TRAINER_PBL_CAITLYN,
    TRAINER_PBL_SYLVIA,
    TRAINER_PBL_THERESA,
    TRAINER_PBL_FRED,
    TRAINER_PBL_MELINDA_OPTIONAL_2,
    TRAINER_PBL_LIZA_BOSS_5,
    TRAINER_PBL_MELANIE,
    TRAINER_PBL_DAISY,
    TRAINER_PBL_FRANK,
    TRAINER_PBL_GILBERT,
    ...
    TRAINER_PBL_WALLY_BOSS_7,
    TRAINER_PBL_BETTY_OPTIONAL_7,
    ...
    TRAINER_PBL_MARS_BOSS_8,
    TRAINER_PBL_COOPER,
    TRAINER_PBL_CARMINE,
    TRAINER_PBL_LUIS,
    TRAINER_PBL_DEMI,
    TRAINER_PBL_CALVIN,
    TRAINER_PBL_ARI_BOSS_9,
    TRAINER_PBL_BERTHA_BOSS_9,
    TRAINER_PBL_CASSANDRA_BOSS_9,
    TRAINER_PBL_DOMINIC_BOSS_9,
    TRAINER_PBL_ALANA,
    TRAINER_PBL_DEWEY,
    TRAINER_PBL_ELIAS,
    TRAINER_PBL_PEARLIE,
    TRAINER_PBL_CONRAD,
    TRAINER_PBL_KYLE,
    TRAINER_PBL_JASMINE_BOSS_10,
    TRAINER_PBL_JEANETTE,
    TRAINER_PBL_JOEL,
    TRAINER_PBL_MARION,
    TRAINER_PBL_REGINA,
    TRAINER_PBL_ROCKET_GRUNT_11A_1,
    TRAINER_PBL_ROCKET_GRUNT_11A_2,
    TRAINER_PBL_ARCHER_BOSS_11,
    TRAINER_PBL_HILDA,
    TRAINER_PBL_TREVOR,
    TRAINER_PBL_ADAIR,
    TRAINER_PBL_KINLEY,
    ...
    TRAINER_PBL_ABIGAIL,
    TRAINER_PBL_CELIA,
    TRAINER_PBL_INVER_BOSS_12,
    TRAINER_PBL_VIOLET,
    TRAINER_PBL_WANDA,
    TRAINER_PBL_BENJAMIN,
    TRAINER_PBL_GERALT,
    TRAINER_PBL_STEVE,
    TRAINER_PBL_SERENA_BOSS_13,
    TRAINER_PBL_MAGMA_GRUNT_13B_1,
    TRAINER_PBL_MAGMA_GRUNT_13B_2,
    TRAINER_PBL_MAGMA_GRUNT_13B_3,
    TRAINER_PBL_NEWTON_BOSS_13,
    TRAINER_PBL_MAGMA_GRUNT_14A_1,
    TRAINER_PBL_MAGMA_GRUNT_14A_2,
    TRAINER_PBL_MAGMA_GRUNT_14A_3,
    TRAINER_PBL_MAGMA_GRUNT_14A_4,
    TRAINER_PBL_MAGMA_GRUNT_14B_1,
    TRAINER_PBL_MAGMA_GRUNT_14B_2,
    TRAINER_PBL_MAGMA_GRUNT_14B_3,
    TRAINER_PBL_COURTNEY_BOSS_14,
    TRAINER_PBL_IONA,
    TRAINER_PBL_BERKE,
    TRAINER_PBL_TANISHA,
    TRAINER_PBL_ROBERT,
    TRAINER_PBL_CHRISTINA,
    TRAINER_PBL_ANGUS,
    TRAINER_PBL_GALACTIC_GRUNT_16A_1,
    TRAINER_PBL_GALACTIC_GRUNT_16A_2,
    TRAINER_PBL_JUPITER_BOSS_16,
    TRAINER_PBL_LEAF_BOSS_17,
    TRAINER_PBL_DORIS,
    TRAINER_PBL_HOMER,
    TRAINER_PBL_JOHN,
    TRAINER_PBL_RACHEL,
    ...
    TRAINER_PBL_ELTON,
    TRAINER_PBL_WILLIE,
    TRAINER_PBL_LARRY_BOSS_18,
    TRAINER_PBL_AQUA_GRUNT_19D_1_BOSS_19,
    TRAINER_PBL_AQUA_GRUNT_19D_2_BOSS_19,
    TRAINER_PBL_AQUA_GRUNT_19D_3_BOSS_19,
    TRAINER_PBL_MATT_BOSS_19,
    TRAINER_PBL_WINSTON,
    TRAINER_PBL_VIVIAN,
    TRAINER_PBL_HAYES,
    TRAINER_PBL_OPHELIA,
    ...
    TRAINER_PBL_DUNCAN,
    TRAINER_PBL_EVALINE,
    TRAINER_PBL_CILAN_BOSS_20,
    TRAINER_PBL_CHILI_BOSS_20,
    TRAINER_PBL_CRESS_BOSS_20,
    TRAINER_PBL_BERNARD,
    TRAINER_PBL_ANITA,
    TRAINER_PBL_HOWARD,
    TRAINER_PBL_ELOISE,
    ...
    TRAINER_PBL_ANNIE,
    TRAINER_PBL_CLARK,
    TRAINER_PBL_LACEY_BOSS_23,
    TRAINER_PBL_DOUGLAS,
    TRAINER_PBL_HAYWOOD,
    TRAINER_PBL_SPENCER,
    TRAINER_PBL_CHRISTI,
    TRAINER_PBL_DAVID,
    TRAINER_PBL_ROCKET_GRUNT_24A_1_BOSS_24,
    TRAINER_PBL_ROCKET_GRUNT_24A_2_BOSS_24,
    TRAINER_PBL_ROCKET_GRUNT_24A_3_BOSS_24,
    TRAINER_PBL_ROCKET_GRUNT_24A_4_BOSS_24,
    TRAINER_PBL_ROCKET_GRUNT_25D_1,
    TRAINER_PBL_ROCKET_GRUNT_25E_1,
    TRAINER_PBL_ROCKET_GRUNT_25F_1,
    TRAINER_PBL_ROCKET_GRUNT_25F_2,
    TRAINER_PBL_ROCKET_GRUNT_25G_1,
    TRAINER_PBL_ROCKET_GRUNT_25H_1,
    TRAINER_PBL_ROCKET_GRUNT_25H_2,
    TRAINER_PBL_ROCKET_GRUNT_25I_1,
    TRAINER_PBL_ROCKET_GRUNT_25J_1,
    TRAINER_PBL_ROCKET_GRUNT_25J_2,
    TRAINER_PBL_ROCKET_GRUNT_25K_1,
    TRAINER_PBL_ROCKET_GRUNT_25K_2,
    TRAINER_PBL_ARIANA_BOSS_25,
    TRAINER_PBL_SERENA_BOSS_27,
    TRAINER_PBL_RAIHAN_BOSS_28,
    TRAINER_PBL_KIMONO_GIRL_1_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_2_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_3_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_4_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_5_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_6_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_7_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_8_BOSS_29,
    TRAINER_PBL_KIMONO_GIRL_9_BOSS_29,
    TRAINER_PBL_PROTON_BOSS_30,
    TRAINER_PBL_LEAF_PARTNER_30,
    TRAINER_PBL_WALLY_PARTNER_30,
    TRAINER_PBL_SERENA_PARTNER_30,
    TRAINER_PBL_MARS_BOSS_30,
    TRAINER_PBL_JUPITER_BOSS_30,
    TRAINER_PBL_COURTNEY_BOSS_30,
    TRAINER_PBL_TABITHA_BOSS_30,
    TRAINER_PBL_MATT_BOSS_30,
    TRAINER_PBL_SHELLY_BOSS_30,
    TRAINER_PBL_ARCHER_BOSS_30,
    TRAINER_PBL_ARIANA_BOSS_30,
    TRAINER_PBL_LEAF_BOSS_31,
    TRAINER_PBL_WALLY_BOSS_32,
    TRAINER_PBL_SERENA_BOSS_32,
    TRAINER_PBL_MAXIE_BOSS_34,
    TRAINER_PBL_ARCHIE_BOSS_34,
    TRAINER_PBL_CYRUS_BOSS_34,
    TRAINER_PBL_GIOVANNI_BOSS_34,
    TRAINER_PBL_LACEY_BOSS_35,
    TRAINER_PBL_GLACIA_BOSS_35,
    TRAINER_PBL_KOGA_BOSS_35,
    TRAINER_PBL_SHAUNTAL_BOSS_35,
    TRAINER_PBL_CYNTHIA_BOSS_35,
    TRAINER_POOL_ZONE_1,
    TRAINER_POOL_ZONE_2,
    TRAINER_POOL_ZONE_3,
    TRAINER_POOL_ZONE_4,
    TRAINER_POOL_ZONE_4_GRUNTS,
    TRAINER_POOL_ZONE_5,
    TRAINER_POOL_ZONE_6,
    ...
    TRAINER_POOL_ZONE_11_GRUNTS,
    TRAINER_POOL_ZONE_12,
    TRAINER_POOL_ZONE_13_AND_14,
    TRAINER_POOL_ZONE_13_AND_14_GRUNTS,
    TRAINER_POOL_ZONE_16,
    TRAINER_POOL_ZONE_16_GRUNTS,
    TRAINER_POOL_ZONE_18_AND_19,
    TRAINER_POOL_ZONE_20,
    TRAINER_POOL_ZONE_20_FOOD,
    TRAINER_POOL_ZONE_21,
    TRAINER_POOL_ZONE_22,
    TRAINER_POOL_ZONE_23,
    TRAINER_POOL_ZONE_24_AND_25,
    TRAINER_POOL_ZONE_25_GRUNTS,
    TRAINER_POOL_ZONE_27_AND_28,
    TRAINER_POOL_ZONE_29,
    // TRAINER_POOL_ZONE_30_GRUNTS,
    TRAINER_POOL_ZONE_31_AND_32_AND_33_GRUNTS,
    TRAINER_POOL_ENDGAME,
    TRAINER_PBL_SHAWN,
