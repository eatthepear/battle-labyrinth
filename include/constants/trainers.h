...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_SOCIALITE,
    TRAINER_PIC_FRONT_BACKPACKER_F,
    TRAINER_PIC_FRONT_WORKER,
    TRAINER_PIC_FRONT_ICE_WORKER,
    TRAINER_PIC_FRONT_ROUGHNECK,
    TRAINER_PIC_FRONT_SERENA,
    TRAINER_PIC_FRONT_KIMONO_GIRL,
    TRAINER_PIC_FRONT_LIZA,
    TRAINER_PIC_FRONT_RAINBOW_ROCKET_GRUNT_F,
    TRAINER_PIC_FRONT_RAINBOW_ROCKET_GRUNT_M,
    TRAINER_PIC_FRONT_RAINBOW_ROCKET_GIOVANNI,
    TRAINER_PIC_FRONT_GALACTIC_GRUNT_F,
    TRAINER_PIC_FRONT_GALACTIC_GRUNT_M,
    TRAINER_PIC_FRONT_MARS,
    TRAINER_PIC_FRONT_JUPITER,
    TRAINER_PIC_FRONT_SATURN,
    TRAINER_PIC_FRONT_CYRUS,
    TRAINER_PIC_FRONT_JASMINE,
    TRAINER_PIC_FRONT_LARRY,
