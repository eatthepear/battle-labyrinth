...
enum
{
    ...
    OBJ_EVENT_GFX_ITEM_CHEST,
    OBJ_EVENT_GFX_ITEM_CHEST_OPEN,
    OBJ_EVENT_GFX_TM_CHEST,
    OBJ_EVENT_GFX_TM_CHEST_OPEN,
    ...
    OBJ_EVENT_GFX_ICE_WORKER,
    OBJ_EVENT_GFX_ROUGHNECK,
    OBJ_EVENT_GFX_SWIMMER_F_WALKING,
    ...
    OBJ_EVENT_GFX_RARE_CANDY,
    OBJ_EVENT_GFX_RAINBOW_ROCKET_MEMBER_F,
    OBJ_EVENT_GFX_RAINBOW_ROCKET_MEMBER_M,
    OBJ_EVENT_GFX_RAINBOW_ROCKET_GIOVANNI,
    OBJ_EVENT_GFX_GALACTIC_MEMBER_F,
    OBJ_EVENT_GFX_GALACTIC_MEMBER_M,
    OBJ_EVENT_GFX_MARS,
    ...
    OBJ_EVENT_GFX_RAIHAN,
    OBJ_EVENT_GFX_SERVER_M,
    OBJ_EVENT_GFX_SERVER_F,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_MAYLENE                 0x7292
#define OBJ_EVENT_PAL_TAG_RAIHAN                  0x7293
#define OBJ_EVENT_PAL_TAG_SERVER_M                0x7294
#define OBJ_EVENT_PAL_TAG_SERVER_F                0x7295
