...
static struct SecretBase UNUSED *sSecretBasesSave;
static TVShow UNUSED *sTvShowsSave;
static PokeNews UNUSED *sPokeNewsSave;
static OldMan *sOldManSave;
static struct DewfordTrend UNUSED *sDewfordTrendsSave;
static struct RecordMixingDaycareMail UNUSED *sRecordMixMailSave;
static void UNUSED *sBattleTowerSave;
static LilycoveLady *sLilycoveLadySave;
static void UNUSED *sApprenticesSave;
static void UNUSED *sBattleTowerSave_Duplicate;
static u32 sRecordStructSize;
static u8 sDaycareMailRandSum;
static struct PlayerHallRecords UNUSED *sPartnerHallRecords[HALL_RECORDS_COUNT];

static EWRAM_DATA struct RecordMixingDaycareMail UNUSED sRecordMixMail = {0};
...
static void UNUSED PrepareExchangePacket(void)
{
...
static void UNUSED PrintTextOnRecordMixing(const u8 *src)
{
...
static void UNUSED Task_RecordMixing_SoundEffect(u8 taskId)
{
...
static void UNUSED Task_MixingRecordsRecv(u8 taskId)
{
...
static void UNUSED Task_SendPacket(u8 taskId)
{
    struct Task *task = &gTasks[taskId];
    switch (task->tState)
    {
...
static void UNUSED Task_CopyReceiveBuffer(u8 taskId)
{
    struct Task *task = &gTasks[taskId];
...
static void UNUSED StorePtrInTaskData(void *records, u16 *asShort)
{
    asShort[0] = (u32)records;
    asShort[1] = ((u32)records >> 16);
}

static u8 UNUSED GetMultiplayerId_(void)
{
    return GetMultiplayerId();
}

static void UNUSED *GetPlayerRecvBuffer(u8 id)
{
    return gBlockRecvBuffer[id];
}

static void UNUSED ShufflePlayerIndices(u32 *data)
{
    u32 i;
    u32 linkTrainerId;
...
static u8 UNUSED GetDaycareMailItemId(struct DaycareMail *mail)
{
...
static void UNUSED SwapDaycareMail(struct RecordMixingDaycareMail *records, size_t recordSize, u8 (*idxs)[2], u8 playerSlot1, u8 playerSlot2)
{
...
static u8 UNUSED GetDaycareMailRandSum(void)
{
...
static void UNUSED Task_DoRecordMixing(u8 taskId)
{
    struct Task *task = &gTasks[taskId];
