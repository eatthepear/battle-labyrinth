...
static const u8 sText_Lanettes[] = _("Colress'"); //no decapitalize until it is everywhere
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXP]                        = COMPOUND_STRING("{B_BUFF1} gained{B_BUFF2} Exp. Points!\p"),
