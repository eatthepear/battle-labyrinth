...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("Add {STR_VAR_1} to your party and\nsend a party member to the PC?"), //no decapitalize until it is everywhere
...
static const u8 *BattleStringGetOpponentClassByTrainerId(u16 trainerId)
{
    ...
    else if (gTrainers[0][trainerId].mugshotEnabled == TRUE)
