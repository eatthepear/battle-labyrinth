...
static u8 UNUSED sTVShowMixingNumPlayers;
static u8 UNUSED sTVShowNewsMixingNumPlayers;
static s8 UNUSED sTVShowMixingCurSlot;

static EWRAM_DATA u16 UNUSED sPokemonAnglerSpecies = 0;
static EWRAM_DATA u16 UNUSED sPokemonAnglerAttemptCounters = 0;
static EWRAM_DATA u16 UNUSED sFindThatGamerCoinsSpent = 0;
static EWRAM_DATA u8 UNUSED sFindThatGamerWhichGame = SLOT_MACHINE;
static EWRAM_DATA ALIGNED(4) u8 UNUSED sRecordMixingPartnersWithoutShowsToShare = 0;
static EWRAM_DATA ALIGNED(4) u8 UNUSED sTVShowState = 0;
static EWRAM_DATA u8 UNUSED sTVSecretBaseSecretsRandomValues[3] = {};
...
void UNUSED ClearTVShowData(void)
{
    // u8 i, j;
...
u8 UNUSED GetRandomActiveShowIdx(void)
{
    // u8 i;
    // u8 j;
    // u8 selIdx;
...
u8 UNUSED FindAnyTVShowOnTheAir(void)
{
...
void UNUSED UpdateTVScreensOnMap(int width, int height)
{
...
static void UNUSED SetTVMetatilesOnMap(int width, int height, u16 metatileId)
{
    int x;
    int y;
...
u8 UNUSED GetSelectedTVShow(void)
{
...
u8 UNUSED GetNextActiveShowIfMassOutbreak(void)
{
    // TVShow *tvShow;
...
void UNUSED ResetGabbyAndTy(void)
{
...
void UNUSED GabbyAndTyBeforeInterview(void)
{
    // u8 i;
...
void UNUSED GabbyAndTyAfterInterview(void)
{
...
u8 UNUSED GabbyAndTyGetBattleNum(void)
{
...
bool8 UNUSED IsGabbyAndTyShowOnTheAir(void)
{
    // return gSaveBlock1Ptr->gabbyAndTyData.onAir;
    return FALSE;
}

bool8 UNUSED GabbyAndTyGetLastQuote(void)
{
...
u8 UNUSED GabbyAndTyGetLastBattleTrivia(void)
{
...
void UNUSED GetGabbyAndTyLocalIds(void)
{
...
void UNUSED InterviewAfter(void)
{
...
void UNUSED TryPutPokemonTodayOnAir(void)
{
    // u8 i;
    // u16 ballsUsed;
    // TVShow *show;
...
static void UNUSED InterviewAfter_ContestLiveUpdates(void)
{
    // TVShow *show;
    // TVShow *show2;
...
void UNUSED PutBattleUpdateOnTheAir(u8 opponentLinkPlayerId, u16 move, u16 speciesPlayer, u16 speciesOpponent)
{
    // TVShow *show;
    // u8 name[32];
...
bool8 UNUSED Put3CheersForPokeblocksOnTheAir(const u8 *partnersName, u8 flavor, u8 color, u8 sheen, u8 language)
{
    // TVShow *show;
    // u8 name[32];
...
void UNUSED PutFanClubSpecialOnTheAir(void)
{
    // TVShow *show;
    // u8 name[32];
    // u32 id;
...
void UNUSED ContestLiveUpdates_Init(u8 round1Placing)
{
    // TVShow *show;
...
void UNUSED ContestLiveUpdates_SetRound2Placing(u8 round2Placing)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[LAST_TVSHOW_IDX];
    // sCurTVShowSlot = FindFirstEmptyNormalTVShowSlot(gSaveBlock1Ptr->tvShows);
    // if (sCurTVShowSlot != -1)
...
void UNUSED ContestLiveUpdates_SetWinnerAppealFlag(u8 flag)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[LAST_TVSHOW_IDX];
    // sCurTVShowSlot = FindFirstEmptyNormalTVShowSlot(gSaveBlock1Ptr->tvShows);
    // if (sCurTVShowSlot != -1)
...
void UNUSED ContestLiveUpdates_SetWinnerMoveUsed(u16 move)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[LAST_TVSHOW_IDX];
    // sCurTVShowSlot = FindFirstEmptyNormalTVShowSlot(gSaveBlock1Ptr->tvShows);
    // if (sCurTVShowSlot != -1)
...
void UNUSED ContestLiveUpdates_SetLoserData(u8 flag, u8 loser)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[LAST_TVSHOW_IDX];
    // sCurTVShowSlot = FindFirstEmptyNormalTVShowSlot(gSaveBlock1Ptr->tvShows);
    // if (sCurTVShowSlot != -1)
...
static void UNUSED InterviewAfter_BravoTrainerPokemonProfile(void)
{
    // TVShow *show;
    // TVShow *show2;
...
void UNUSED BravoTrainerPokemonProfile_BeforeInterview1(u16 move)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[LAST_TVSHOW_IDX];
...
void UNUSED BravoTrainerPokemonProfile_BeforeInterview2(u8 contestStandingPlace)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[LAST_TVSHOW_IDX];
    // sCurTVShowSlot = FindFirstEmptyNormalTVShowSlot(gSaveBlock1Ptr->tvShows);
    // if (sCurTVShowSlot != -1)
...
static void UNUSED InterviewAfter_BravoTrainerBattleTowerProfile(void)
{
...
void UNUSED TryPutSmartShopperOnAir(void)
{
    // TVShow *show;
    // u8 i;
...
void UNUSED PutNameRaterShowOnTheAir(void)
{
    // TVShow *show;
...
void UNUSED StartMassOutbreak(void)
{
...
void UNUSED PutLilycoveContestLadyShowOnTheAir(void)
{
    // TVShow *show;
...
static void UNUSED InterviewAfter_FanClubLetter(void)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
static void UNUSED InterviewAfter_RecentHappenings(void)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
static void UNUSED InterviewAfter_PkmnFanClubOpinions(void)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[sCurTVShowSlot];
...
void UNUSED EndMassOutbreak(void)
{
...
void UNUSED UpdateTVShowsPerDay(u16 days)
{
...
static void UNUSED UpdateMassOutbreakTimeLeft(u16 days)
{
    // u8 i;
    // TVShow *show;
...
static void UNUSED TryEndMassOutbreak(u16 days)
{
...
void UNUSED RecordFishingAttemptForTV(bool8 caughtFish)
{
    // if (caughtFish)
    // {
...
static void UNUSED TryPutFishingAdviceOnAir(void)
{
    // TVShow *show;
...
void UNUSED SetPokemonAnglerSpecies(u16 species)
{
...
void UNUSED TryPutTodaysRivalTrainerOnAir(void)
{
    // TVShow *show;
    // u32 i;
    // u8 nBadges;
...
void UNUSED TryPutTrendWatcherOnAir(const u16 *words)
{
    // TVShow *show;
...
void UNUSED TryPutTreasureInvestigatorsOnAir(void)
{
    // TVShow *show;
...
void UNUSED TryPutFindThatGamerOnAir(u16 nCoinsPaidOut)
{
    // TVShow *show;
    // bool8 flag;
    // u16 nCoinsWon;
...
void UNUSED AlertTVThatPlayerPlayedSlotMachine(u16 nCoinsSpent)
{
    // sFindThatGamerWhichGame = SLOT_MACHINE;
    // sFindThatGamerCoinsSpent = nCoinsSpent;
}

void UNUSED AlertTVThatPlayerPlayedRoulette(u16 nCoinsSpent)
{
...
void UNUSED TryPutSecretBaseVisitOnAir(void)
{
    // TVShow *show;
...
void UNUSED TryPutBreakingNewsOnAir(void)
{
    // TVShow *show;
    // u8 i;
    // u16 balls;
...
void UNUSED TryPutLotteryWinnerReportOnAir(void)
{
    // TVShow *show;
...
void UNUSED TryPutBattleSeminarOnAir(u16 foeSpecies, u16 species, u8 moveIdx, const u16 *movePtr, u16 betterMove)
{
    // TVShow *show;
    // u8 i;
    // u8 j;
...
void UNUSED TryPutSafariFanClubOnAir(u8 monsCaught, u8 pokeblocksUsed)
{
    // TVShow *show;
...
void UNUSED TryPutSpotTheCutiesOnAir(struct Pokemon *pokemon, u8 ribbonMonDataIdx)
{
    // TVShow *show;
...
u8 UNUSED GetRibbonCount(struct Pokemon *pokemon)
{
    // u8 nRibbons;
...
void UNUSED TryPutTrainerFanClubOnAir(void)
{
    // TVShow *show;
...
bool8 UNUSED ShouldHideFanClubInterviewer(void)
{
    // sCurTVShowSlot = FindFirstEmptyNormalTVShowSlot(gSaveBlock1Ptr->tvShows);
    // if (sCurTVShowSlot == -1)
    //     return TRUE;
...
bool8 UNUSED ShouldAirFrontierTVShow(void)
{
    // u32 playerId;
    // u8 showIdx;
    // TVShow *shows;
...
void UNUSED TryPutFrontierTVShowOnAir(u16 winStreak, u8 facilityAndMode)
{
    // TVShow *show;
...
void UNUSED TryPutSecretBaseSecretsOnAir(void)
{
    // TVShow *show;
    // u8 strbuf[32];
...
static s8 UNUSED GetFirstEmptyPokeNewsSlot(PokeNews *pokeNews)
{
    s8 i;
...
static void UNUSED ClearPokeNewsBySlot(u8 i)
{
...
static u8 UNUSED FindAnyPokeNewsOnTheAir(void)
{
    // u8 i;
...
bool8 UNUSED IsPokeNewsActive(u8 newsKind)
{
    // u8 i;
...
void UNUSED CopyContestRankToStringVar(u8 varIdx, u8 rank)
{
    switch (rank)
    {
...
void UNUSED CopyContestCategoryToStringVar(u8 varIdx, u8 category)
{
    switch (category)
    {
...
void UNUSED SetContestCategoryStringVarForInterview(void)
{
    // TVShow *show = &gSaveBlock1Ptr->tvShows[gSpecialVar_0x8004];
    // CopyContestCategoryToStringVar(1, show->bravoTrainer.contestCategory);
}

void UNUSED ConvertIntToDecimalString(u8 varIdx, int value)
{
...
static void UNUSED TryReplaceOldTVShowOfKind(u8 kind)
{
    // u8 i;
...
void UNUSED InterviewBefore(void)
{
    gSpecialVar_Result = FALSE;
    switch (gSpecialVar_0x8005)
    {
...
static void UNUSED InterviewBefore_FanClubLetter(void)
{
...
static void UNUSED InterviewBefore_RecentHappenings(void)
{
...
static void UNUSED InterviewBefore_PkmnFanClubOpinions(void)
{
...
static void UNUSED InterviewBefore_Dummy(void)
{
    gSpecialVar_Result = TRUE;
}

static void UNUSED InterviewBefore_NameRater(void)
{
    TryReplaceOldTVShowOfKind(TVSHOW_NAME_RATER_SHOW);
}

static void UNUSED InterviewBefore_BravoTrainerPkmnProfile(void)
{
...
static void UNUSED InterviewBefore_ContestLiveUpdates(void)
{
    TryReplaceOldTVShowOfKind(TVSHOW_CONTEST_LIVE_UPDATES);
}

static void UNUSED InterviewBefore_3CheersForPokeblocks(void)
{
    TryReplaceOldTVShowOfKind(TVSHOW_3_CHEERS_FOR_POKEBLOCKS);
}

static void UNUSED InterviewBefore_BravoTrainerBTProfile(void)
{
...
static void UNUSED InterviewBefore_FanClubSpecial(void)
{
    // TryReplaceOldTVShowOfKind(TVSHOW_FAN_CLUB_SPECIAL);
    // if (!gSpecialVar_Result)
...
static bool8 UNUSED IsPartyMonNicknamedOrNotEnglish(u8 monIdx)
{
...
bool8 UNUSED IsLeadMonNicknamedOrNotEnglish(void)
{
    return IsPartyMonNicknamedOrNotEnglish(GetLeadMonIndex());
}

static void UNUSED DeleteTVShowInArrayByIdx(TVShow *shows, u8 idx)
{
    u8 i;
...
static u16 UNUSED GetRandomDifferentSpeciesAndNameSeenByPlayer(u8 varIdx, u16 excludedSpecies)
{
...
static u16 UNUSED GetRandomDifferentSpeciesSeenByPlayer(u16 excludedSpecies)
{
...
static s8 UNUSED FindFirstEmptyRecordMixTVShowSlot(TVShow *shows)
{
    s8 i;
...
static void UNUSED GetNicknameSubstring(u8 varIdx, u8 whichPosition, u8 charParam, u16 whichString, u16 species, TVShow *show)
{
    u8 buff[16];
    u8 i;
    u16 strlen;
...
bool8 UNUSED TryPutNameRaterShowOnTheAir(void)
{
    GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_NICKNAME, gStringVar1);
...
void UNUSED ChangePokemonNickname(void)
{
    void UNUSED ChangePokemonNickname_CB(void);
...
void UNUSED ChangeBoxPokemonNickname(void)
{
...
static void UNUSED ChangeBoxPokemonNickname_CB(void)
{
    SetBoxMonNickAt(gSpecialVar_MonBoxId, gSpecialVar_MonBoxPos, gStringVar2);
    CB2_ReturnToFieldContinueScriptPlayMapMusic();
}

void UNUSED BufferMonNickname(void)
{
    GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_NICKNAME, gStringVar1);
    StringGet_Nickname(gStringVar1);
}

void UNUSED IsMonOTIDNotPlayers(void)
{
...
static u8 UNUSED GetTVGroupByShowId(u8 kind)
{
...
u8 UNUSED CheckForPlayersHouseNews(void)
{
...
void UNUSED GetMomOrDadStringForTVMessage(void)
{
...
void UNUSED HideBattleTowerReporter(void)
{
...
void UNUSED ReceiveTvShowsData(void UNUSED *src, u32 size, u8 playersLinkId)
{
    // u8 i;
    // u16 version;
...
static bool8 UNUSED TryMixTVShow(TVShow *dest[TV_SHOWS_COUNT], TVShow *src[TV_SHOWS_COUNT], u8 idx)
{
    bool8 success;
    u8 type;
    TVShow *tv1 = *dest;
...
static bool8 UNUSED TryMixNormalTVShow(TVShow *dest, TVShow *src, u8 idx)
{
...
static bool8 UNUSED TryMixRecordMixTVShow(TVShow *dest, TVShow *src, u8 idx)
{
    u32 linkTrainerId = GetLinkPlayerTrainerId(idx);
...
static bool8 UNUSED TryMixOutbreakTVShow(TVShow *dest, TVShow *src, u8 idx)
{
    u32 linkTrainerId = GetLinkPlayerTrainerId(idx);
...
static s8 UNUSED FindInactiveShowInArray(TVShow *tvShows)
{
    u8 i;
...
static void UNUSED DeactivateShowIfNotSeenSpecies(u16 species, u8 showIdx)
{
...
void UNUSED DeactivateAllNormalTVShows(void)
{
    // u8 i;
...
void UNUSED ReceivePokeNewsData(void UNUSED *src, u32 size, u8 playersLinkId)
{
    // u8 i;
...
static void UNUSED InitTryMixPokeNewsShow(PokeNews *dest[POKE_NEWS_COUNT], PokeNews *src[POKE_NEWS_COUNT])
{
    PokeNews *ptr1 = *dest;
    PokeNews *ptr2 = *src;
...
static bool8 UNUSED TryMixPokeNewsShow(PokeNews *dest, PokeNews *src, s8 slot)
{
    u8 i;
...
static s8 UNUSED GetPokeNewsSlotIfActive(PokeNews *pokeNews, u8 idx)
{
...
void UNUSED SanitizeTVShowsForRuby(TVShow *shows)
{
    TVShow *curShow;
...
static u8 UNUSED GetStringLanguage(u8 *str)
{
...
void UNUSED SanitizeTVShowLocationsForRuby(TVShow *shows)
{
    int i;
...
void UNUSED DoTVShowInSearchOfTrainers(void)
{
    // u8 state;
...
static void UNUSED DoTVShowTheWorldOfMasters(void)
{
    // TVShow *show;
    // u8 state;
...
u8 UNUSED SecretBaseSecrets_GetNumActionsTaken(TVShow *show)
{
    u8 i;
    u8 flagsSet;
...
void UNUSED ResetTVShowState(void)
{
    sTVShowState = 0;
}
