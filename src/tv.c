...
static UNUSED enum Species GetRandomDifferentSpeciesAndNameSeenByPlayer(u8 varIdx, enum Species excludedSpecies)
{
...
static UNUSED void GetNicknameSubstring(u8 varIdx, u8 whichPosition, u8 charParam, u16 whichString, enum Species species, TVShow *show)
{
    u8 buff[16];
    u8 i;
    u16 strlen;
...
static UNUSED void DeactivateShowIfNotSeenSpecies(enum Species species, u8 showIdx)
{
#if FREE_OTHER_PBL == FALSE
