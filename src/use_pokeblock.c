...
static void UNUSED CalculatePokeblockEffectiveness(struct Pokeblock *pokeblock, struct Pokemon *mon)
{
...
static void UNUSED SpriteCB_MonPic(struct Sprite *sprite)
{
