...
const struct BattleBackground sBattleEnvironmentTable[] =
{
    ...
    [BATTLE_ENVIRONMENT_DESERT] =
    {
        ...
        .entryTileset = gBattleEnvironmentAnimTiles_Desert,
        .entryTilemap = gBattleEnvironmentAnimTilemap_Desert,
    ...
    [BATTLE_ENVIRONMENT_FOREST] =
    {
        ...
        .entryTileset = gBattleEnvironmentAnimTiles_TallGrass,
        .entryTilemap = gBattleEnvironmentAnimTilemap_TallGrass,
        .palette = gBattleEnvironmentPalette_Forest,
    },
    ...
    [BATTLE_ENVIRONMENT_BRIDGE] =
    {
        ...
        .entryTileset = gBattleEnvironmentAnimTiles_Bridge,
        .entryTilemap = gBattleEnvironmentAnimTilemap_Bridge,
