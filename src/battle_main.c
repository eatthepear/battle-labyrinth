...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua Admin"), 5 },
    [TRAINER_CLASS_BLACK_BELT] = { _("Black Belt"), 2, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("Aqua Leader"), 10, BALL_MASTER },
    ...
    [TRAINER_CLASS_BEAUTY] = { _("Beauty"), 2, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    ...
    [TRAINER_CLASS_LEADER] = { _("Leader"), 10 },
    ...
    [TRAINER_CLASS_FAIRY_TALE_GIRL] = { _("Fairy Tale Girl"), 2, BALL_FRIEND },
    ...
    [TRAINER_CLASS_KIMONO_GIRL] = { _("Kimono Girl"), 2 },
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 firstTrainer, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            u32 abilityNum = 0;
            u8 nature;
            u8 level = GetInfiniteCandyLevelCap() - 1;
