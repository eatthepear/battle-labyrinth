...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_LADY] = { _("Lady"), 3 },
    [TRAINER_CLASS_BEAUTY] = { _("Beauty"), 2 },
    [TRAINER_CLASS_RICH_BOY] = { _("Rich Boy"), 3 },
    ...
    [TRAINER_CLASS_WINSTRATE] = { _("Winstrate"), 2 },
    ...
    [TRAINER_CLASS_MAGMA_LEADER] = { _("Magma Leader"), BALL_MASTER },
