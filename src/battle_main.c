...
// PBL prize money = 4 for easy, 8 for medium, 12 for hard. rich people are *2.5. bosses are 15 for regular bosses, 25 for leaders, 50 for endgame. double battles = same as singles. 
...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COLLECTOR] = { _("Collector"), 8, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("Swimmer ♂"), 8, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("Team Magma"), 8 },
    [TRAINER_CLASS_EXPERT] = { _("Expert"), 12 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua Admin"), 15 },
    [TRAINER_CLASS_BLACK_BELT] = { _("Black Belt"), 8, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("Aqua Leader"), 25, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("Hex Maniac"), 8 },
    [TRAINER_CLASS_AROMA_LADY] = { _("Aroma Lady"), 8 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("Ruin Maniac"), 8 },
    [TRAINER_CLASS_INTERVIEWER] = { _("Interviewer"), 8 },
    [TRAINER_CLASS_TUBER_F] = { _("Tuber"), 4 },
    [TRAINER_CLASS_TUBER_M] = { _("Tuber"), 4 },
    [TRAINER_CLASS_LADY] = { _("Lady"), 20 },
    [TRAINER_CLASS_BEAUTY] = { _("Beauty"), 8, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_GREAT : BALL_POKE },
    [TRAINER_CLASS_RICH_BOY] = { _("Rich Boy"), 20 },
    [TRAINER_CLASS_POKEMANIAC] = { _("Poké Maniac"), 8 },
    ...
    [TRAINER_CLASS_BUG_MANIAC] = { _("Bug Maniac"), 8 },
    [TRAINER_CLASS_PSYCHIC] = { _("Psychic"), 8 },
    [TRAINER_CLASS_GENTLEMAN] = { _("Gentleman"), 40, BALL_LUXURY },
    ...
    [TRAINER_CLASS_POKEFAN] = { _("Pokéfan"), 8 },
    ...
    [TRAINER_CLASS_TRIATHLETE] = { _("Triathlete"), 8 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("Dragon Tamer"), 8 },
    ...
    [TRAINER_CLASS_TWINS] = { _("Twins"), 4 },
    [TRAINER_CLASS_SAILOR] = { _("Sailor"), 8 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Ace Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("Magma Admin"), 15 },
    ...
    [TRAINER_CLASS_OLD_COUPLE] = { _("Old Couple"), 12 },
    ...
    [TRAINER_CLASS_BUG_CATCHER_FRLG] =     { _("Bug Catcher"), 4 },
    [TRAINER_CLASS_LASS_FRLG] =            { _("Lass"), 4 },
    [TRAINER_CLASS_SAILOR_FRLG] =          { _("Sailor"), 8 },
    [TRAINER_CLASS_CAMPER_FRLG] =          { _("Camper"), 8 },
    [TRAINER_CLASS_PICNICKER_FRLG] =       { _("Picnicker"), 8 },
    [TRAINER_CLASS_POKEMANIAC_FRLG] =      { _("Poké Maniac"), 8 },
    [TRAINER_CLASS_SUPER_NERD_FRLG] =      { _("Super Nerd"), 8 },
    [TRAINER_CLASS_HIKER_FRLG] =           { _("Hiker"), 8 },
    [TRAINER_CLASS_BIKER_FRLG] =           { _("Biker"), 8 },
    [TRAINER_CLASS_BURGLAR_FRLG] =         { _("Burglar"), 8 },
    [TRAINER_CLASS_ENGINEER_FRLG] =        { _("Engineer"), 8 },
    [TRAINER_CLASS_FISHERMAN_FRLG] =       { _("Fisherman"), 8, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_SWIMMER_M_FRLG] =       { _("Swimmer ♂"), 8 },
    [TRAINER_CLASS_CUE_BALL_FRLG] =        { _("Cue Ball"), 8 },
    [TRAINER_CLASS_GAMER_FRLG] =           { _("Gamer"), 8 },
    [TRAINER_CLASS_BEAUTY_FRLG] =          { _("Beauty"), 8 },
    [TRAINER_CLASS_SWIMMER_F_FRLG] =       { _("Swimmer ♀"), 8, BALL_DIVE },
    [TRAINER_CLASS_PSYCHIC_FRLG] =         { _("Psychic"), 8 },
    [TRAINER_CLASS_ROCKER_FRLG] =          { _("Rocker"), 8 },
    [TRAINER_CLASS_JUGGLER_FRLG] =         { _("Juggler"), 8 },
    [TRAINER_CLASS_TAMER_FRLG] =           { _("Tamer"), 8 },
    [TRAINER_CLASS_BIRD_KEEPER_FRLG] =     { _("Bird Keeper"), 8 },
    [TRAINER_CLASS_BLACK_BELT_FRLG] =      { _("Black Belt"), 8, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL_EARLY_FRLG] =     { _("Rival"), 15 },
    [TRAINER_CLASS_SCIENTIST_FRLG] =       { _("Scientist"), 8 },
    [TRAINER_CLASS_BOSS_FRLG] =            { _("Boss"), 25 },
    [TRAINER_CLASS_LEADER_FRLG] =          { _("Leader"), 25 },
    [TRAINER_CLASS_TEAM_ROCKET_FRLG] =     { _("Team Rocket"), 8 },
    [TRAINER_CLASS_COOLTRAINER_FRLG] =     { _("Ace Trainer"), 12, BALL_ULTRA },
    [TRAINER_CLASS_ELITE_FOUR_FRLG] =      { _("Elite Four"), 25, BALL_ULTRA },
    [TRAINER_CLASS_GENTLEMAN_FRLG] =       { _("Gentleman"), 40, BALL_LUXURY },
    [TRAINER_CLASS_RIVAL_LATE_FRLG] =      { _("Rival"), 15 },
    [TRAINER_CLASS_CHAMPION_FRLG] =        { _("Champion"), 25 },
    [TRAINER_CLASS_CHANNELER_FRLG] =       { _("Channeler"), 8 },
    [TRAINER_CLASS_TWINS_FRLG] =           { _("Twins"), 4 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("Ace Duo"), 12 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("Young Couple"), 8 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("Crush Kin"), 8 },
    [TRAINER_CLASS_SIS_AND_BRO_FRLG] =     { _("Sis and Bro"), 4 },
    [TRAINER_CLASS_PKMN_PROF_FRLG] =       { _("{PKMN} Prof."), 25 },
    [TRAINER_CLASS_PLAYER_FRLG] =          { _("{PKMN} TRAINER"), 1 },
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("Crush Girl"), 8 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("Tuber"), 4 },
    [TRAINER_CLASS_PKMN_BREEDER_FRLG] =    { _("{PKMN} Breeder"), 8, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_PKMN_RANGER_FRLG] =     { _("{PKMN} Ranger"), 12 },
    [TRAINER_CLASS_AROMA_LADY_FRLG] =      { _("Aroma Lady"), 8 },
    [TRAINER_CLASS_RUIN_MANIAC_FRLG] =     { _("Ruin Maniac"), 8 },
    [TRAINER_CLASS_LADY_FRLG] =            { _("Lady"), 20 },
    ...
    [TRAINER_CLASS_WORKER] = { _("Worker"), 8, BALL_HEAVY },
    [TRAINER_CLASS_ROUGHNECK] = { _("Roughneck"), 8, BALL_NEST },
    [TRAINER_CLASS_KIMONO_GIRL] = { _("Kimono Girl"), 12 },
    [TRAINER_CLASS_RAINBOW_ROCKET] = { _("Rainbow Rocket"), 8, BALL_GREAT },
    [TRAINER_CLASS_RAINBOW_ROCKET_EXECUTIVE] = { _("Rainbow Rocket Executive"), 15, BALL_ULTRA },
    [TRAINER_CLASS_RAINBOW_ROCKET_BOSS] = { _("Rainbow Rocket Boss"), 25, BALL_MASTER },
...
void SwitchPartyOrder(enum BattlerId battler)
{
    ...
    if (IsDoubleBattle())
    {
        ...
        {
            *(battler * 3 + i + (u8 *)(gBattleStruct->battlerPartyOrders)) = gBattlePartyCurrentOrder[i];
            if (BattlersShareParty(battler, GetPartnerBattler(battler))) // Custom. We need this to handle 1v2 battles, because those aren't treated as multi battles.
                *(GetPartnerBattler(battler) * 3 + i + (u8 *)(gBattleStruct->battlerPartyOrders)) = gBattlePartyCurrentOrder[i];
        }
    }
    else
