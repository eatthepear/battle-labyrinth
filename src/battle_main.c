...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} Breeder"), B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("Ace Trainer"), BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("Bird Keeper") },
    [TRAINER_CLASS_COLLECTOR] = { _("Collector"), BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("Swimmer♂"), BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("Team Magma") },
    [TRAINER_CLASS_EXPERT] = { _("Expert") },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua Admin") },
    [TRAINER_CLASS_BLACK_BELT] = { _("Black Belt"), BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("Aqua Leader"), BALL_MASTER },
    ...
    [TRAINER_CLASS_SWIMMER_F] = { _("Swimmer♀"), BALL_DIVE },
    ...
    [TRAINER_CLASS_WAITER] = { _("Waiter"), BALL_LUXURY },
    [TRAINER_CLASS_WAITRESS] = { _("Waitress"), BALL_LUXURY },
    [TRAINER_CLASS_FAIRY_TALE_GIRL] = { _("FaeTaleGirl"), BALL_FRIEND },
    [TRAINER_CLASS_SOCIALITE] = { _("Socialite"), 5, BALL_LUXURY },
    [TRAINER_CLASS_BACKPACKER] = { _("Backpacker"), BALL_GREAT },
    [TRAINER_CLASS_WORKER] = { _("Worker"), BALL_HEAVY },
    [TRAINER_CLASS_ROUGHNECK] = { _("Roughneck"), BALL_NEST },
};
