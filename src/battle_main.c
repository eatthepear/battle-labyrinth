...
static u32 CalculateExperienceFromTrainer(u32 trainerNum) {
    ...
    const struct Trainer *trainer = &gTrainers[0][trainerNum];
            ...
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                ...
                case B_ACTION_VIEW_ENEMY_PARTY:
                    ...
                    else
                    {
                        ...
                        BtlController_EmitChoosePokemon(battler, B_COMM_TO_CONTROLLER, PARTY_ACTION_CHOOSE_MON, PARTY_SIZE, ABILITY_NONE, gBattleStruct->battlerPartyOrders[battler+1]);
                        MarkBattlerForControllerExec(battler);
                    }
                    break;
