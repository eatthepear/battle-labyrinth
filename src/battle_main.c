...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("Hiker"), 2 },
    [TRAINER_CLASS_TEAM_AQUA] = { _("Team Aqua"), 2 },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("{PKMN} Breeder"), 2, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_HEAL : BALL_FRIEND },
    [TRAINER_CLASS_COOLTRAINER] = { _("Ace Trainer"), 2, BALL_ULTRA },
    [TRAINER_CLASS_BIRD_KEEPER] = { _("Bird Keeper"), 2 },
    [TRAINER_CLASS_COLLECTOR] = { _("Collector"), 2, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("Swimmer♂"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("Team Magma"), 2 },
    [TRAINER_CLASS_EXPERT] = { _("Expert"), 2 },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua Admin"), 2 },
    [TRAINER_CLASS_BLACK_BELT] = { _("Black Belt"), 2, BALL_ULTRA },
    [TRAINER_CLASS_AQUA_LEADER] = { _("Aqua Leader"), 5, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("Hex Maniac"), 2 },
    [TRAINER_CLASS_AROMA_LADY] = { _("Aroma Lady"), 2 },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("Ruin Maniac"), 2 },
    [TRAINER_CLASS_INTERVIEWER] = { _("Interviewer"), 2 },
    [TRAINER_CLASS_TUBER_F] = { _("Tuber"), 2 },
    [TRAINER_CLASS_TUBER_M] = { _("Tuber"), 2 },
    [TRAINER_CLASS_LADY] = { _("Lady"), 4 },
    [TRAINER_CLASS_BEAUTY] = { _("Beauty"), 2 },
    [TRAINER_CLASS_RICH_BOY] = { _("Rich Boy"), 4 },
    [TRAINER_CLASS_POKEMANIAC] = { _("Poké Maniac"), 2 },
    [TRAINER_CLASS_GUITARIST] = { _("Guitarist"), 2 },
    [TRAINER_CLASS_KINDLER] = { _("Kindler"), 2 },
    [TRAINER_CLASS_CAMPER] = { _("Camper"), 2 },
    [TRAINER_CLASS_PICNICKER] = { _("Picnicker"), 2 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("Bug Maniac"), 2 },
    [TRAINER_CLASS_PSYCHIC] = { _("Psychic"), 2 },
    [TRAINER_CLASS_GENTLEMAN] = { _("Gentleman"), 5, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("Elite Four"), 5, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("Leader"), 5 },
    [TRAINER_CLASS_SCHOOL_KID] = { _("School Kid"), 1 },
    [TRAINER_CLASS_SR_AND_JR] = { _("Teammates"), 2 },
    [TRAINER_CLASS_WINSTRATE] = { _("Winstrate"), 4 },
    [TRAINER_CLASS_POKEFAN] = { _("Pokéfan"), 2 },
    [TRAINER_CLASS_YOUNGSTER] = { _("Youngster"), 1 },
    [TRAINER_CLASS_CHAMPION] = { _("Champion"), 10 },
    [TRAINER_CLASS_FISHERMAN] = { _("Fisherman"), 2, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("Triathlete"), 2 },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("Dragon Tamer"), 2 },
    [TRAINER_CLASS_NINJA_BOY] = { _("Ninja Boy"), 2 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("Battle Girl"), 2 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("Parasol Lady"), 2 },
    [TRAINER_CLASS_SWIMMER_F] = { _("Swimmer♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("Twins"), 1 },
    [TRAINER_CLASS_SAILOR] = { _("Sailor"), 2 },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Leviathan") }, // only used for the string
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("Magma Admin"), 2 },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} Trainer"), 2 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("Bug Catcher"), 1 },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} Ranger"), 2 },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("Magma Leader"), 5, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("Lass"), 1 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("Young Couple"), 2 },
    [TRAINER_CLASS_OLD_COUPLE] = { _("Old Couple"), 2 },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("Sis and Bro"), 2 },
    ...
    [TRAINER_CLASS_SCIENTIST] = { _("Scientist"), 2, BALL_REPEAT },
    [TRAINER_CLASS_WAITER] = { _("Waiter"), 2, BALL_LUXURY },
    [TRAINER_CLASS_WAITRESS] = { _("Waitress"), 2, BALL_LUXURY },
    [TRAINER_CLASS_FAIRY_TALE_GIRL] = { _("FaeTaleGirl"), 2, BALL_FRIEND },
    [TRAINER_CLASS_SOCIALITE] = { _("Socialite"), 5, BALL_LUXURY },
    [TRAINER_CLASS_BACKPACKER] = { _("Backpacker"), 2, BALL_GREAT },
    [TRAINER_CLASS_WORKER] = { _("Worker"), 2, BALL_HEAVY },
    [TRAINER_CLASS_ROUGHNECK] = { _("Roughneck"), 2, BALL_NEST },
};
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 firstTrainer, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            if (partyData[j].iv != NULL)
            {
                SetMonData(&party[i], MON_DATA_HP_IV, &(partyData[j].iv[0]));
                SetMonData(&party[i], MON_DATA_ATK_IV, &(partyData[j].iv[1]));
                SetMonData(&party[i], MON_DATA_DEF_IV, &(partyData[j].iv[2]));
                SetMonData(&party[i], MON_DATA_SPATK_IV, &(partyData[j].iv[3]));
                SetMonData(&party[i], MON_DATA_SPDEF_IV, &(partyData[j].iv[4]));
                SetMonData(&party[i], MON_DATA_SPEED_IV, &(partyData[j].iv[5]));
            }
...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum, bool8 firstTrainer)
{
    ...
    u32 totalExp = 0;
    for (u32 i = TRAINER_PBL_VIOLET; i <= TRAINER_PBL_DARWIN; i++) {
        totalExp += CalculateExperienceFromTrainer(i);
    }
    for (u32 i = TRAINER_PBL_BART; i <= TRAINER_PBL_RANDOLPH; i++) {
        totalExp += CalculateExperienceFromTrainer(i);
    }
