...
static const u16 sPrizeListRareCandy1[]  = {ITEM_POTION,       ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListLuxuryBall1[] = {ITEM_POTION,      ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListMaxRevive1[]  = {ITEM_POTION,       ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListMaxEther1[]   = {ITEM_POTION,        ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListElixir1[]     = {ITEM_POTION,           ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListRoar[]        = {ITEM_POTION,          ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListSludgeBomb[]  = {ITEM_POTION,   ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListToxic[]       = {ITEM_POTION,         ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListSunnyDay[]    = {ITEM_POTION,     ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListEarthQuake[]  = {ITEM_POTION,    ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};

static const u16 sPrizeListRareCandy2[]  = {ITEM_POTION,       ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListLuxuryBall2[] = {ITEM_POTION,      ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListMaxRevive2[]  = {ITEM_POTION,       ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListMaxEther2[]   = {ITEM_POTION,        ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListElixir2[]     = {ITEM_POTION,           ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListBrickBreak[]  = {ITEM_POTION,   ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListTorment[]     = {ITEM_POTION,       ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListSkillSwap[]   = {ITEM_POTION,    ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListGigaDrain[]   = {ITEM_POTION,    ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
static const u16 sPrizeListAttract[]     = {ITEM_POTION,       ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION, ITEM_POTION};
...
static u16 GetPrizeItemId(void)
{
    ...
    // entering the Hall of Fame, there would be 1 additional prize possibility (ITEM_POTION)
