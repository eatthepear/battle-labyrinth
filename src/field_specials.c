...
u16 GetNumTrainersRemaining(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        for (trainer = TRAINER_PBL_JEMMA; trainer <= TRAINER_PBL_MELINDA_OPTIONAL_1; trainer++) {
            if (!HasTrainerBeenFought(trainer))
                count += 1;
        }
    ...
    case 4:
        ...
        break;
    case 5:
        for (trainer = TRAINER_PBL_REBECCA; trainer <= TRAINER_PBL_BILL_OPTIONAL_2; trainer++) {
            if (!HasTrainerBeenFought(trainer))
                count += 1;
        }
    ...
    case 8:
        ...
        break;
    case 9:
        for (trainer = TRAINER_PBL_COOPER; trainer <= TRAINER_PBL_KIMBERLY; trainer++) {
            if (!HasTrainerBeenFought(trainer))
                count += 1;
        }
...
u16 RandomItemChest(void)
{
    ...
    {
        percentTotal += sItemChestTable[i].percentage[split];
