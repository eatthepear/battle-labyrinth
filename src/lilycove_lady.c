...
static const u8 UNUSED *GetFavorLadyRequest(u8 idx)
{
...
static void UNUSED FavorLadyBufferPrizeName(u16 prize)
{
...
bool8 UNUSED BufferQuizAuthorNameAndCheckIfLady(void)
{
    // sQuizLadyPtr = &gSaveBlock1Ptr->lilycoveLady.quiz;
