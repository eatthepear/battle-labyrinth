...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_PANGORO}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SLIGGOO},
                                {EVO_ITEM, ITEM_JUBILIFE_MUFFIN, SPECIES_SLIGGOO_HISUIAN}),
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG},
                                {EVO_ITEM, ITEM_JUBILIFE_MUFFIN, SPECIES_AVALUGG_HISUIAN}),
    },
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ICE_BODY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Avalugg"),
        .cryId = CRY_AVALUGG,
        .natDexNum = NATIONAL_DEX_AVALUGG,
