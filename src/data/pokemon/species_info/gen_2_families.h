...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION(
                            #if P_HISUIAN_FORMS
                                {EVO_LEVEL, 36, SPECIES_TYPHLOSION_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
                            #endif
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 12, SPECIES_LEDIAN}),
    },
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_YANMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FRISK, ABILITY_COMPOUND_EYES, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Yanma"),
        .cryId = CRY_YANMA,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FRISK, ABILITY_TINTED_LENS, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_GREEN,
