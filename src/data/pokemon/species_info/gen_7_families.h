...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_PID_UPPER_MODULO_10_GT, 4})},
                                {EVO_LEVEL, 25, SPECIES_LYCANROC_MIDNIGHT, CONDITIONS({IF_PID_UPPER_MODULO_10_LT, 5})}),
    },
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STAMINA, ABILITY_NONE, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 13, SPECIES_STEENEE}),
    },
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYMBIOSIS, ABILITY_TELEPATHY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
