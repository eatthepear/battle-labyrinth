...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION(
                            #if P_HISUIAN_FORMS
                                {EVO_LEVEL, 36, SPECIES_SAMUROTT_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
                            #endif
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION(
                            #if P_HISUIAN_FORMS
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
                            #endif
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION(
                            #if P_HISUIAN_FORMS
                                {EVO_LEVEL, 34, SPECIES_BRAVIARY_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
                            #endif
