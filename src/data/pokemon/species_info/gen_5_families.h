...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
    ...
    [SPECIES_AUDINO] =
    {
        ...
        .abilities = { ABILITY_HEALER, ABILITY_KLUTZ, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
    ...
    [SPECIES_SWANNA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
        .abilities = { ABILITY_NO_GUARD, ABILITY_BIG_PECKS, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_BRAVIARY_HISUI, CONDITIONS({IF_IN_MAPSEC, MAPSEC_QUIET_FIELD})},
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_FLASH_FIRE, ABILITY_WHITE_SMOKE },
        .bodyColor = BODY_COLOR_RED,
