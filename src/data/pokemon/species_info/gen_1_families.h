...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM_HOLD, ITEM_LUCKY_PUNCH, SPECIES_BLISSEY},
                                {EVO_ITEM, ITEM_LUCKY_PUNCH, SPECIES_BLISSEY}),
    },
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_NONE, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
