...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_VITAL_SPIRIT, ABILITY_SOLAR_POWER },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_TECHNICIAN, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SURGE_SURFER, ABILITY_SURGE_SURFER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Raichu"),
        .cryId = CRY_RAICHU,
        .natDexNum = NATIONAL_DEX_RAICHU,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_CLEFAIRY}),
    },
#endif //P_GEN_2_CROSS_EVOS
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_NONE, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_UNAWARE, ABILITY_OWN_TEMPO, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING},
                                {EVO_LEVEL, 0, SPECIES_WEEZING_GALAR, CONDITIONS({IF_KNOWS_MOVE, MOVE_HAZE})}),
    },
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BLISSEY, CONDITIONS({IF_HOLD_ITEM, ITEM_LUCKY_PUNCH})}),
    #endif
    },
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_SEAKING}),
    },
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_KNOWS_MOVE, MOVE_MIMIC})},
                                {EVO_LEVEL, 0, SPECIES_MR_MIME, CONDITIONS({IF_KNOWS_MOVE, MOVE_ICY_WIND})}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_ELECTRIC_GEM, SPECIES_JOLTEON},
                                {EVO_ITEM, ITEM_WATER_GEM, SPECIES_VAPOREON},
                                {EVO_ITEM, ITEM_FIRE_GEM, SPECIES_FLAREON},
                                {EVO_ITEM, ITEM_PSYCHIC_GEM, SPECIES_ESPEON},
                                {EVO_ITEM, ITEM_DARK_GEM, SPECIES_UMBREON},
                                {EVO_ITEM, ITEM_GRASS_GEM, SPECIES_LEAFEON},
                                {EVO_ITEM, ITEM_ICE_GEM, SPECIES_GLACEON},
