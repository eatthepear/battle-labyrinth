...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_WATER_VEIL, ABILITY_DAMP },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .abilities = { ABILITY_TELEPATHY, ABILITY_TRACE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ralts"),
        .cryId = CRY_RALTS,
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PINK_SCARF, SPECIES_DELCATTY}),
    },
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_SOLID_ROCK, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_TRADE_ITEM, ITEM_PRISM_SCALE, SPECIES_MILOTIC},
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INSOMNIA, ABILITY_CURSED_BODY, ABILITY_NONE },
    #else
