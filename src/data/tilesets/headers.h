...
const struct Tileset gTileset_GymsExterior =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_GymsExterior,
    .palettes = gTilesetPalettes_GymsExterior,
    .metatiles = gMetatiles_GymsExterior,
...
const struct Tileset gTileset_Virtual =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Virtual,
    .palettes = gTilesetPalettes_Virtual,
    .metatiles = gMetatiles_Virtual,
    .metatileAttributes = gMetatileAttributes_Virtual,
    .callback = NULL,
};

const struct Tileset gTileset_FallRuins =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_FallRuins,
    .palettes = gTilesetPalettes_FallRuins,
    .metatiles = gMetatiles_FallRuins,
