...
const u32 gTrainerFrontPic_Waiter[] = INCBIN_U32("graphics/trainers/front_pics/Waiter_front_pic.4bpp.smol");
const u16 gTrainerPalette_Waiter[] = INCBIN_U16("graphics/trainers/palettes/Waiter.gbapal");

const u32 gTrainerFrontPic_Waitress[] = INCBIN_U32("graphics/trainers/front_pics/Waitress_front_pic.4bpp.smol");
const u16 gTrainerPalette_Waitress[] = INCBIN_U16("graphics/trainers/palettes/Waitress.gbapal");

const u32 gTrainerFrontPic_FairyTaleGirl[] = INCBIN_U32("graphics/trainers/front_pics/fairy_tale_girl_front_pic.4bpp.smol");
const u16 gTrainerPalette_FairyTaleGirl[] = INCBIN_U16("graphics/trainers/palettes/fairy_tale_girl.gbapal");

const u32 gTrainerFrontPic_Socialite[] = INCBIN_U32("graphics/trainers/front_pics/socialite_front_pic.4bpp.smol");
const u16 gTrainerPalette_Socialite[] = INCBIN_U16("graphics/trainers/palettes/socialite.gbapal");

const u32 gTrainerFrontPic_BackpackerF[] = INCBIN_U32("graphics/trainers/front_pics/backpacker_f_front_pic.4bpp.smol");
const u16 gTrainerPalette_BackpackerF[] = INCBIN_U16("graphics/trainers/palettes/backpacker_f.gbapal");

const u32 gTrainerFrontPic_Worker[] = INCBIN_U32("graphics/trainers/front_pics/worker_front_pic.4bpp.smol");
const u16 gTrainerPalette_Worker[] = INCBIN_U16("graphics/trainers/palettes/worker.gbapal");

const u32 gTrainerFrontPic_IceWorker[] = INCBIN_U32("graphics/trainers/front_pics/ice_worker_front_pic.4bpp.smol");
const u16 gTrainerPalette_IceWorker[] = INCBIN_U16("graphics/trainers/palettes/ice_worker.gbapal");

const u32 gTrainerFrontPic_Roughneck[] = INCBIN_U32("graphics/trainers/front_pics/roughneck_front_pic.4bpp.smol");
const u16 gTrainerPalette_Roughneck[] = INCBIN_U16("graphics/trainers/palettes/roughneck.gbapal");

const u32 gTrainerFrontPic_Serena[] = INCBIN_U32("graphics/trainers/front_pics/serena.4bpp.smol");
const u16 gTrainerPalette_Serena[] = INCBIN_U16("graphics/trainers/palettes/serena.gbapal");

const u32 gTrainerFrontPic_KimonoGirl[] = INCBIN_U32("graphics/trainers/front_pics/kimono_girl.4bpp.smol");
const u16 gTrainerPalette_KimonoGirl[] = INCBIN_U16("graphics/trainers/palettes/kimono_girl.gbapal");
...
const u8 gTrainerBackPic_Serena[] = INCBIN_U8("graphics/trainers/back_pics/serena.4bpp");
const u16 gTrainerBackPicPalette_Serena[] = INCBIN_U16("graphics/trainers/back_pics/serena.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SOCIALITE, gTrainerFrontPic_Socialite, gTrainerPalette_Socialite),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BACKPACKER_F, gTrainerFrontPic_BackpackerF, gTrainerPalette_BackpackerF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_WORKER, gTrainerFrontPic_Worker, gTrainerPalette_Worker),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ICE_WORKER, gTrainerFrontPic_IceWorker, gTrainerPalette_IceWorker),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RAINBOW_ROCKET_GRUNT_F, gTrainerFrontPic_RainbowRocketGruntF, gTrainerPalette_RainbowRocketGruntF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RAINBOW_ROCKET_GRUNT_M, gTrainerFrontPic_RainbowRocketGruntM, gTrainerPalette_RainbowRocketGruntM),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RAINBOW_ROCKET_GIOVANNI, gTrainerFrontPic_RainbowRocketGiovanni, gTrainerPalette_RainbowRocketGiovanni),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MARS, gTrainerFrontPic_Mars, gTrainerPalette_Mars),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_JUPITER, gTrainerFrontPic_Jupiter, gTrainerPalette_Jupiter),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SATURN, gTrainerFrontPic_Saturn, gTrainerPalette_Saturn),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_LARRY, gTrainerFrontPic_Larry, gTrainerPalette_Larry),
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SERENA, 4, gTrainerBackPic_Serena, gTrainerBackPicPalette_Serena, sBackAnims_Hoenn),
