...
const u16 gTrainerPalette_Scientist[] = INCGFX_U16("graphics/trainers/front_pics/Scientist_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_Waiter[] = INCGFX_U32("graphics/trainers/front_pics/Waiter_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_Waiter[] = INCGFX_U16("graphics/trainers/front_pics/Waiter_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_Waitress[] = INCGFX_U32("graphics/trainers/front_pics/Waitress_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_Waitress[] = INCGFX_U16("graphics/trainers/front_pics/Waitress_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_FairyTaleGirl[] = INCGFX_U32("graphics/trainers/front_pics/fairy_tale_girl_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_FairyTaleGirl[] = INCGFX_U16("graphics/trainers/front_pics/fairy_tale_girl_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_Socialite[] = INCGFX_U32("graphics/trainers/front_pics/socialite_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_Socialite[] = INCGFX_U16("graphics/trainers/front_pics/socialite_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_BackpackerF[] = INCGFX_U32("graphics/trainers/front_pics/backpacker_f_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_BackpackerF[] = INCGFX_U16("graphics/trainers/front_pics/backpacker_f_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_Worker[] = INCGFX_U32("graphics/trainers/front_pics/worker_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_Worker[] = INCGFX_U16("graphics/trainers/front_pics/worker_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_IceWorker[] = INCGFX_U32("graphics/trainers/front_pics/ice_worker_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_IceWorker[] = INCGFX_U16("graphics/trainers/front_pics/ice_worker_front_pic.png", ".gbapal");

const u32 gTrainerFrontPic_Roughneck[] = INCGFX_U32("graphics/trainers/front_pics/roughneck_front_pic.png", ".4bpp.smol");
const u16 gTrainerPalette_Roughneck[] = INCGFX_U16("graphics/trainers/front_pics/roughneck_front_pic.png", ".gbapal");
...
const u32 gTrainerFrontPic_Liza[] = INCGFX_U32("graphics/trainers/front_pics/liza.png", ".4bpp.smol");
const u16 gTrainerPalette_Liza[] = INCGFX_U16("graphics/trainers/front_pics/liza.png", ".gbapal");

const u32 gTrainerFrontPic_RainbowRocketGruntF[] = INCGFX_U32("graphics/trainers/front_pics/rainbow_rocket_grunt_f.png", ".4bpp.smol");
const u16 gTrainerPalette_RainbowRocketGruntF[] = INCGFX_U16("graphics/trainers/front_pics/rainbow_rocket_grunt_f.png", ".gbapal");

const u32 gTrainerFrontPic_RainbowRocketGruntM[] = INCGFX_U32("graphics/trainers/front_pics/rainbow_rocket_grunt_m.png", ".4bpp.smol");
const u16 gTrainerPalette_RainbowRocketGruntM[] = INCGFX_U16("graphics/trainers/front_pics/rainbow_rocket_grunt_m.png", ".gbapal");

const u32 gTrainerFrontPic_RainbowRocketGiovanni[] = INCGFX_U32("graphics/trainers/front_pics/rainbow_rocket_giovanni.png", ".4bpp.smol");
const u16 gTrainerPalette_RainbowRocketGiovanni[] = INCGFX_U16("graphics/trainers/front_pics/rainbow_rocket_giovanni.png", ".gbapal");
...
const u32 gTrainerFrontPic_Mars[] = INCGFX_U32("graphics/trainers/front_pics/mars.png", ".4bpp.smol");
const u16 gTrainerPalette_Mars[] = INCGFX_U16("graphics/trainers/front_pics/mars.png", ".gbapal");

const u32 gTrainerFrontPic_Jupiter[] = INCGFX_U32("graphics/trainers/front_pics/jupiter.png", ".4bpp.smol");
const u16 gTrainerPalette_Jupiter[] = INCGFX_U16("graphics/trainers/front_pics/jupiter.png", ".gbapal");
...
const struct TrainerPicInfo gTrainerPicInfo[TRAINER_PIC_COUNT] =
{
    ...
    [TRAINER_PIC_ICE_WORKER] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_IceWorker, gTrainerPalette_IceWorker),
    },
    ...
    [TRAINER_PIC_SERENA] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(1, gTrainerBackPic_Serena, gTrainerBackPicPalette_Serena, sBackAnims_Hoenn),
    },
    ...
    [TRAINER_PIC_RAINBOW_ROCKET_GRUNT_F] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_RainbowRocketGruntF, gTrainerPalette_RainbowRocketGruntF),
    },
    [TRAINER_PIC_RAINBOW_ROCKET_GRUNT_M] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_RainbowRocketGruntM, gTrainerPalette_RainbowRocketGruntM),
    },
    [TRAINER_PIC_RAINBOW_ROCKET_GIOVANNI] =
    {
        .frontPic = TRAINER_FRONT_PIC(gTrainerFrontPic_RainbowRocketGiovanni, gTrainerPalette_RainbowRocketGiovanni),
    },
