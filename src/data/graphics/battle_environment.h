...
const u32 gBattleEnvironmentAnimTiles_Bridge[] = INCBIN_U32("graphics/battle_environment/bridge/anim_tiles.4bpp.lz");
const u32 gBattleEnvironmentAnimTilemap_Bridge[] = INCBIN_U32("graphics/battle_environment/bridge/anim_map.bin.lz");
...
const u32 gBattleEnvironmentAnimTiles_Desert[] = INCBIN_U32("graphics/battle_environment/desert/anim_tiles.4bpp.lz");
const u32 gBattleEnvironmentAnimTilemap_Desert[] = INCBIN_U32("graphics/battle_environment/desert/anim_map.bin.lz");

const u16 gBattleEnvironmentPalette_Forest[] = INCBIN_U16("graphics/battle_environment/tall_grass/palette2.gbapal");
