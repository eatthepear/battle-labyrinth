...
const u16 gBattleEnvironmentPalette_Forest[] = INCGFX_U16("graphics/battle_environment/tall_grass/forest_palette.pal", ".gbapal");
...
const u32 gBattleEnvironmentTiles_Bridge[] = INCGFX_U32("graphics/battle_environment/bridge/tiles.png", ".4bpp.smol");
const u16 gBattleEnvironmentPalette_Bridge[] = INCGFX_U16("graphics/battle_environment/bridge/palette.pal", ".gbapal");
const u32 gBattleEnvironmentTilemap_Bridge[] = INCGFX_U32("graphics/battle_environment/bridge/map.bin", ".smolTM");

const u32 gBattleEnvironmentTiles_Desert[] = INCGFX_U32("graphics/battle_environment/desert/tiles.png", ".4bpp.smol");
const u16 gBattleEnvironmentPalette_Desert[] = INCGFX_U16("graphics/battle_environment/desert/palette.pal", ".gbapal");
const u32 gBattleEnvironmentTilemap_Desert[] = INCGFX_U32("graphics/battle_environment/desert/map.bin", ".smolTM");
...
const u32 gBattleEnvironmentAnimTiles_Desert[] = INCGFX_U32("graphics/battle_environment/desert/anim_tiles.png", ".4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_Desert[] = INCGFX_U32("graphics/battle_environment/desert/anim_map.bin", ".smolTM");

const u32 gBattleEnvironmentAnimTiles_Forest[] = INCGFX_U32("graphics/battle_environment/tall_grass/anim_tiles.png", ".4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_Forest[] = INCGFX_U32("graphics/battle_environment/tall_grass/anim_map.bin", ".smolTM");

const u32 gBattleEnvironmentAnimTiles_Bridge[] = INCGFX_U32("graphics/battle_environment/bridge/anim_tiles.png", ".4bpp.smol");
const u32 gBattleEnvironmentAnimTilemap_Bridge[] = INCGFX_U32("graphics/battle_environment/bridge/anim_map.bin", ".smolTM");
