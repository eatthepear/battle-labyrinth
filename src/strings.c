...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to to the Sanctuary,\nprotecting the exhausted and fainted\nPokémon from further harm…\p");
...
const u8 gText_MapZone12[] = _("Zone 12 - Twinstream Plains");
...
const u8 gText_MapZoneS2[] = _("S2 - Forest River Safari");
