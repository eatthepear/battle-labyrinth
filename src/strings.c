...
const u8 gText_MapZone5[] = _("Zone 5 - Mossdeep Path");
...
const u8 gText_MapZone9[] = _("Zone 9 - Lush Village");
...
const u8 gText_MapZone5Short[] = _("Zone 5 MossdeepPath");
const u8 gText_MapZone6Short[] = _("Zone 6 SeabreezIsland");
const u8 gText_MapZone7Short[] = _("Zone 7 GeminiHeights");

//// side quest data
//generic strings
const u8 gText_QuestAnnounce[] = _("The quest {COLOR RED}{STR_VAR_1}{COLOR DARK_GRAY}\nis now {COLOR GREEN}{STR_VAR_2}{COLOR DARK_GRAY}.");
const u8 gText_SubQuestAnnounce[] = _("The subquest {COLOR RED}{STR_VAR_1}{COLOR DARK_GRAY}\nis now {COLOR GREEN}complete{COLOR DARK_GRAY}.");
...
const u8 gText_SideQuestDesc_PBL[] = _("Complete all 50 Zones!\nSo far you've completed {STR_VAR_1} Zones!");
