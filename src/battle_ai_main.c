...
static u32 AI_CalcMoveEffectScore(u32 battlerAtk, u32 battlerDef, u32 move)
{
    ...
    case EFFECT_REVIVAL_BLESSING:
        ...
        break;
    case EFFECT_NO_RETREAT:
        IncreaseStatUpScore(battlerAtk, battlerDef, STAT_SPEED);
        IncreaseStatUpScore(battlerAtk, battlerDef, STAT_ATK);
        IncreaseStatUpScore(battlerAtk, battlerDef, STAT_DEF);
        IncreaseStatUpScore(battlerAtk, battlerDef, STAT_SPATK);
        IncreaseStatUpScore(battlerAtk, battlerDef, STAT_SPDEF);
        break;
