...
const u16 gMoveTypes_Pal[] = INCGFX_U16("graphics/types/move_types.pal", ".gbapal", "-num_colors 64");
const u32 gTeraTypes_Gfx[] = INCGFX_U32("graphics/types/tera/tera_types.4bpp", ".smol");
