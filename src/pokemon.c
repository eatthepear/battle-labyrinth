...
const u16 gEvolutionLines[NUM_SPECIES][EVOS_PER_LINE] =
{
    ...
    [SPECIES_WOOPER ... SPECIES_QUAGSIRE]                       = {SPECIES_WOOPER, SPECIES_QUAGSIRE, SPECIES_WOOPER_PALDEAN, SPECIES_CLODSIRE},
    [SPECIES_WOOPER_PALDEAN]                                    = {SPECIES_WOOPER, SPECIES_QUAGSIRE, SPECIES_WOOPER_PALDEAN, SPECIES_CLODSIRE},
    [SPECIES_CLODSIRE]                                          = {SPECIES_WOOPER, SPECIES_QUAGSIRE, SPECIES_WOOPER_PALDEAN, SPECIES_CLODSIRE},
    ...
    [SPECIES_TAUROS]                                            = {SPECIES_TAUROS, SPECIES_TAUROS_PALDEAN_AQUA_BREED, SPECIES_TAUROS_PALDEAN_BLAZE_BREED, SPECIES_TAUROS_PALDEA_COMBAT},
    [SPECIES_TAUROS_PALDEAN_COMBAT_BREED ... SPECIES_TAUROS_PALDEAN_AQUA_BREED]                                         = {SPECIES_TAUROS, SPECIES_TAUROS_PALDEAN_COMBAT_BREED, SPECIES_TAUROS_PALDEAN_AQUA_BREED, SPECIES_TAUROS_PALDEAN_BLAZE_BREED},
    ...
    [SPECIES_LECHONK ... SPECIES_OINKOLOGNE]                    =          {SPECIES_LECHONK, SPECIES_OINKOLOGNE, SPECIES_OINKOLOGNE_MALE, SPECIES_OINKOLOGNE_FEMALE},
    [SPECIES_OINKOLOGNE_FEMALE]                                 =          {SPECIES_LECHONK, SPECIES_OINKOLOGNE, SPECIES_OINKOLOGNE_MALE, SPECIES_OINKOLOGNE_FEMALE},
...
static union PokemonSubstruct UNUSED *GetSubstruct(struct BoxPokemon *boxMon, u8 substructType)
{
            ...
            while (effectFlags != 0)
            {
                if (effectFlags & 1)
                {
                    ...
                    case 2: // ITEM4_HEAL_HP
                        ...
                        else if (!(effectFlags & (ITEM4_REVIVE >> 2)) && GetMonData(mon, MON_DATA_HP, NULL) == 0)
                        {
                            itemEffectParam++;
                            break;
                        }
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
    {
        ...
        default:
            if (gTrainers[gTrainerBattleOpponent_A].mugshotEnabled == TRUE) {
                ...
                case 5:
                    return MUS_VS_FRONTIER_BRAIN; // TODO
                default:
